...
Seq = seqLoad(Size, 396160, 'data/CA-AstroPh-transform.txt')

# Degree = degreeFromSeq(Seq, Size)
# np.savetxt('data/Astro/degree', Degree, delimiter=',')
Degree = np.loadtxt('data/Astro/degree',  dtype=int, delimiter=',')
...
nodes1 = np.arange(Size)
Seq1 = seqLoad(Size, 396160, 'data/CA-AstroPh-transform.txt')
G1 = nxGraphGen(nodes, Seq)
resu = louvainClustering(G1)
